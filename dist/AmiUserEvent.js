...
(function (UserEvent) {
    ...
    (function (Event) {
        ...
        (function (NewActiveDongle) {
            ...
            function buildAction(imei, iccid, imsi, number, serviceprovider) {
    ...
    (function (Request) {
        ...
        (function (UpdateNumber) {
            UpdateNumber.keyword = "UpdateNumber";
            function matchEvt(evt) {
                return (Request.matchEvt(evt) &&
                    evt.command === UpdateNumber.keyword &&
                    evt.hasOwnProperty("imei") &&
                    evt.hasOwnProperty("number"));
            }
            UpdateNumber.matchEvt = matchEvt;
            function buildAction(imei, number) {
                return __assign({}, Request.buildAction(UpdateNumber.keyword), { imei: imei,
                    number: number });
            }
            UpdateNumber.buildAction = buildAction;
    ...
    (function (Response) {
        ...
        (function (GetActiveDongles) {
            ...
            (function (Entry) {
                ...
                Entry.matchEvt = matchEvt;
                function buildAction(actionid, imei, iccid, imsi, number, serviceprovider) {
