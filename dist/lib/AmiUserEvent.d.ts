...
export declare namespace UserEvent {
    ...
    namespace Event {
        ...
        namespace RequestUnlockCode {
            ...
            function buildAction(imei: string, iccid: string, pinstate: LockedPinState, tryleft: string): RequestUnlockCode;
        }
        ...
        namespace NewActiveDongle {
            ...
            function buildAction(imei: string, iccid: string, imsi: string, number: string, serviceprovider: string): NewActiveDongle;
        }
        ...
        namespace DongleDisconnect {
            ...
            function buildAction(imei: string, iccid: string, imsi: string, number: string, serviceprovider: string): DongleDisconnect;
        }
    ...
    namespace Request {
        ...
        namespace UpdateNumber {
            const keyword = "UpdateNumber";
            function matchEvt(evt: UserEvent): evt is UpdateNumber;
            function buildAction(imei: string, number: string): UpdateNumber;
        }
    ...
    namespace Response {
        ...
        namespace GetActiveDongles {
            ...
            namespace Entry {
                function matchEvt(actionid: string): (evt: UserEvent) => evt is Entry;
                function buildAction(actionid: string, imei: string, iccid: string, imsi: string, number: string, serviceprovider: string): Entry;
            }
        }
    }
}
